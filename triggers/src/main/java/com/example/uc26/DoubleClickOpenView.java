...
/**
 * UC26 — Double-click a row to open it in a new tab.
 * <p>
 ...
 * from "what to do".
 */
@Route(value = "uc26", layout = MainLayout.class)
@PageTitle("UC26 — Double-click → new tab")
@Menu(order = 26, title = "UC26 — Double-click → new tab")
@StyleSheet("uc26.css")
public class DoubleClickOpenView extends VerticalLayout {
    ...
    public DoubleClickOpenView() {
        addClassName("uc26-view");
        add(new H1("UC26 — Double-click → new tab"));
        add(new Paragraph(
