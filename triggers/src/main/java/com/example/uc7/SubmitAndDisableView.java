...
/**
 * UC7 — Submit on Enter, then disable the submit button.
 * <p>
...
@PageTitle("UC7 — Submit + disable chain")
@Menu(order = 7, title = "UC7 — Submit + disable")
@StyleSheet("uc7.css")
public class SubmitAndDisableView extends VerticalLayout {

    public SubmitAndDisableView() {
        addClassName("uc7-view");
        add(new H1("UC7 — Submit on Enter, then disable"));
        add(new Paragraph(
