...
/**
 * UC25 — Dynamic responsive styling.
 * <p>
 ...
 */
@Route(value = "uc25", layout = MainLayout.class)
@PageTitle("UC25 — Dynamic responsive styling")
@Menu(order = 25, title = "UC25 — Dynamic responsive styling")
@StyleSheet("uc25.css")
public class DynamicResponsiveStylingView extends VerticalLayout {

    public DynamicResponsiveStylingView() {
        addClassName("uc25-view");
        add(new H1("UC25 — Dynamic responsive styling"));
        add(new Paragraph(
