...
/**
 * UC24 — Auto-save signal on every keystroke.
 * <p>
 ...
 * (UC14, UC17): that routes through a {@code Consumer<T>} the application
...
@PageTitle("UC24 — Auto-save signal")
@Menu(order = 24, title = "UC24 — Auto-save signal")
@StyleSheet("uc24.css")
public class AutoSaveSignalView extends VerticalLayout {

    public AutoSaveSignalView() {
        addClassName("uc24-view");
        add(new H1("UC24 — Auto-save signal"));
        add(new Paragraph(
