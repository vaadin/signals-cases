...
/**
 * UC27 — Keyboard shortcut triggers a server-handler download.
 * <p>
 ...
 */
@Route(value = "uc27", layout = MainLayout.class)
@PageTitle("UC27 — Shortcut download")
@Menu(order = 27, title = "UC27 — Shortcut download")
@StyleSheet("uc27.css")
public class ShortcutDownloadView extends VerticalLayout {
    ...
    public ShortcutDownloadView() {
        addClassName("uc27-view");
        add(new H1("UC27 — Shortcut download"));
        add(new Paragraph(
