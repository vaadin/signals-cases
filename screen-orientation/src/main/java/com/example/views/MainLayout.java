...
@PageTitle("Screen Orientation API Use Cases")
public class MainLayout extends AppLayout implements BeforeEnterObserver {
    ...
    public MainLayout() {
        ...
        H1 title = new H1("Screen Orientation API Use Cases");
    ...
    private void updateSourceCodeLink(Class<?> viewClass) {
        ...
        String githubUrl = "https://github.com/vaadin/use-cases/tree/main/screen-orientation/src/main/java/"
