...
public class MissingAPI {
     ...
     */
    public static void bindVisible(Component component,
     ...
     */
    public static void bindEnabled(HasEnabled component,
            Signal<Boolean> signal) {
        if (component instanceof Component comp) {
            ComponentEffect.bind(comp, signal,
                    (c, enabled) -> component.setEnabled(enabled));
        }
    }

    /**
     * Binds a Div or other component's text content to a Signal via
     * Element.setText.
     */
    public static void bindElementText(Component component,
            Signal<String> signal) {
        ComponentEffect.bind(component, signal,
                (c, text) -> c.getElement().setText(text != null ? text : ""));
    }

    /**
     * Binds a component's theme name to a Signal.
     */
    public static void bindThemeName(Component component,
            Signal<String> signal) {
     ...
     */
    public static void bindAttribute(Component component, String attributeName,
            Signal<String> signal) {
     ...
     */
    public static void bindClassName(Component component, String className,
            Signal<Boolean> signal) {
     ...
     */
    public static <T, C extends HasValue<?, T>> void bindRequired(C component,
            Signal<Boolean> signal) {
        if (component instanceof Component comp) {
            ComponentEffect.bind(comp, signal, (c, required) -> component
                    .setRequiredIndicatorVisible(required));
        }
    }

    /**
     * Binds a component's helper text to a Signal (for components that support
     * it).
     */
    public static void bindHelperText(Component component,
            Signal<String> signal) {
        ComponentEffect.bind(component, signal,
                (c, helperText) -> c.getElement().setProperty("helperText",
     ...
     */
    public static void bindStyle(Component component, String property,
            Signal<String> signal) {
        ComponentEffect.bind(component, signal, (c, value) -> {
            if (value != null) {
