 ...
 *
 * Demonstrates deep linking and URL state management:
 ...
 *
 * Key Patterns:
 * - Router integration with signals
...
public class UseCase16View extends VerticalLayout implements HasUrlParameter<String>, BeforeEnterObserver {
    ...
    public static class Article {
        ...
        public boolean matches(String query, String category) {
            boolean categoryMatch = category.equals("All") || this.category.equals(category);
            if (query.isEmpty()) {
    ...
    private static final List<Article> ALL_ARTICLES = List.of(
        new Article("1", "Getting Started with Signals", "Tutorial", "Learn the basics of reactive signals..."),
        new Article("2", "Advanced Signal Patterns", "Tutorial", "Deep dive into computed signals and effects..."),
        new Article("3", "Building Reactive UIs", "Guide", "Create dynamic user interfaces with signals..."),
        new Article("4", "Signal API Reference", "Documentation", "Complete API documentation for signals..."),
        new Article("5", "Performance Optimization", "Guide", "Best practices for signal performance..."),
        new Article("6", "Common Pitfalls", "Tutorial", "Avoid these common mistakes when using signals..."),
        new Article("7", "Integration with Binder", "Documentation", "How to use signals with Vaadin Binder..."),
        new Article("8", "Multi-User Signals", "Guide", "Implementing collaborative features..."),
        new Article("9", "Testing Signal-Based Code", "Tutorial", "Unit testing patterns for signals..."),
        new Article("10", "Migration Guide", "Documentation", "Migrating from traditional state to signals...")
    );
    ...
    public UseCase16View() {
        ...
        Anchor link2 = new Anchor("use-case-16?category=Tutorial", "Category: Tutorial");
        link2.getElement().setAttribute("router-link", "");

        Anchor link3 = new Anchor("use-case-16?q=reactive&category=Guide", "Search: 'reactive' in Guide");
        ...
        add(title, description, controls, urlBox, shareTitle, shareLinks, resultsTitle, resultsContainer, infoBox);
    ...
    public void setParameter(BeforeEvent event, String parameter) {
        // URL parameter support (not used in this case, but required by interface)
    }
    ...
    private void updateUrl() {
        ...
        String url = "use-case-16" + (urlParams.length() > 0 ? "?" + urlParams : "");
